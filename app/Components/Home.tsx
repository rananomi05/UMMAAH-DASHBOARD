...
// ✅ Load chart dynamically (fix duplicate import)
const FeatureCharts = dynamic(() => import('./FeatureCharts'), { ssr: false });
        ...
        <div className="p-4 font-lufga sm:ml-64">
            <div className="p-4 rounded-lg mt-6">
                <div className="flex flex-row">
                    {/* Live User Stats */}
                    <div className="w-[777px] h-[332px] border-2 border-gray-300 rounded-[27px] bg-[#F2F2F5]">
                        <div className="flex flex-row">
                            <div>
                            ...
                            <div>
                                ...
                                <div className="w-[234px] h-[267px] font-lufga flex flex-col text-left text-[#000000] bg-[#FFFFFF] mt-1 ml-3 rounded-[19px] p-4">
                                    <p className="font-semibold">
                                        Links{' '}
                                        <span className="border border-[#BFBFBF] rounded-[4px] px-1 py-1">3</span>
                                    </p>
                                    <div className="w-[213px] mt-2 h-[58px] bg-[#F2F2F5] border border-[#239371] rounded-[14px] px-2 py-1">
                                        <h1 className="font-bold font-lufga text-[15px]">
                                            Total Views Today{' '}
                                            <span className="ml-10">
                                                <FontAwesomeIcon icon={faStar} />
                                            </span>
                                        </h1>
                                        <h1 className="text-[11px] pt-2">
                                            12,560 views <span className="text-[#239371] ml-[64px]">+8%</span>
                                        </h1>
                                    </div>
                                    <div className="w-[213px] mt-3 h-[58px] bg-[#F2F2F5] rounded-[14px] px-2 py-1">
                                        ...
                                        <h1 className="text-[11px] pt-2">
                                            5 crashes <span className="ml-[50px]">Critical: 2</span>
                                        </h1>
                                    </div>
                                    <div className="w-[213px] mt-3 h-[58px] bg-[#F2F2F5] rounded-[14px] px-2 py-1">
                                        <h1 className="font-bold font-lufga text-[15px]">
                                        ...
                                        <h1 className="text-xs pt-2">
                                            Login API latency{' '}
                                            <span className="text-[#EA6863] ml-[40px]">120 errors</span>
                                        </h1>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="ml-4 mt-2">
                        <h1 className="text-[#000000] font-bold text-[20px]">
                            Active Users{' '}
                            <span className="bg-[#239371] text-[15px] font-semibold text-white rounded-[7px]">
                                +12%
                            </span>
                            <span>
                                <FontAwesomeIcon
                                    icon={faEllipsisVertical}
                                    className="text-[20px] ml-[70px]"
                                />
                            </span>
                        </h1>
                        <h1 className="font-bold text-[35px]">
                            +83 <span className="text-[#BFBFBF]">%</span>{' '}
                        </h1>
                        <h1 className="text-[15px]">Uptime</h1>
                        <h1 className="font-bold text-[17px]"> Error Rate: 1.2% (Goal: &lt;1%) </h1>
                        <h1 className="font-bold text-[25px]"> Daily Traffic Growth </h1>
                ...
                <div className="flex flex-row">
                        ...
                        <div className="flex flex-row gap-x-1 mt-4">
                            <div className="w-[151px] h-[445px] rounded-[18px] bg-[#F2F2F5]">
                                ...
                                <div className="w-[118px] h-[375px] bg-[#FFFFFF] ml-4 flex flex-col rounded-[23px] mt-2">
                                    ...
                                    <h1 className="text-[15px] w-[69px] pt-[145px] pl-3">
                                        Sessions: <br />
                                        <span className="font-semibold">7,893</span>
                                    </h1>
                                    <h1 className="text-[15px] w-[69px] pt-3 pl-3">
                                        Avg Duration: <br />
                                        <span className="font-semibold">3m 15s</span>
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div className="w-[151px] h-[445px] rounded-[18px] bg-[#F2F2F5]">
                                ...
                                <div className="w-[118px] h-[375px] bg-[#FFFFFF] ml-4 flex flex-col rounded-[23px] mt-2">
                                    ...
                                    <h1 className="text-[15px] w-[69px] pt-[165px] pl-3">
                                        Quran Recitation: <br />
                            ...
                            <div className="w-[151px] h-[445px] rounded-[18px] bg-[#F2F2F5]">
                                ...
                                <div className="w-[118px] h-[375px] bg-[#FFFFFF] ml-4 flex flex-col rounded-[23px] mt-2">
                                    ...
                                    <h1 className="text-[15px] w-[69px] pt-[125px] pl-3">
                                        Community Events: <br />
                                        <span className="font-semibold">9% </span>
                                    </h1>
                                    <h1 className="text-[15px] w-[69px] pt-3 pl-3">
                                        Guides Section : <span className="font-semibold">5%</span>
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div className="w-[151px] h-[445px] rounded-[18px] bg-[#F2F2F5]">
                                ...
                                <div className="w-[118px] h-[375px] bg-[#FFFFFF] ml-4 flex flex-col rounded-[23px] mt-2">
                                    ...
                                    <h1 className="text-[15px] w-[69px] pt-[220px] pl-3">
                                        Affected <br />
                                        <span className="font-semibold">7,893</span>
                                    </h1>
                                </div>
                            ...
                            <div className="w-[151px] h-[445px] rounded-[18px] bg-[#F2F2F5]">
                                ...
                                <div className="w-[118px] h-[375px] bg-[#FFFFFF] ml-4 flex flex-col rounded-[23px] mt-2">
                                    ...
                                    <h1 className="text-[15px] w-[69px] pt-[200px] pl-3">
                    ...
                    <div className="flex flex-col mt-3 ml-4">
                        ...
                        <div className="bg-[#F2F2F5] rounded-[27px] p-4 w-[270px] min-h-[228px] mt-3">
                            {/* Header */}
                            <div className="flex justify-between items-center mb-3">
                                <h1 className="font-semibold text-[18px]">Quick Fix</h1>
                                <div className="flex items-center space-x-2">
                                    <FontAwesomeIcon icon={faTriangleExclamation} className="text-black text-sm" />
                                    <FontAwesomeIcon icon={faEllipsisVertical} className="text-black font-bold" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 text-sm">
                                {/* Row 1 */}
                                <div className="bg-white rounded-[18px] px-3 py-2">
                                    <div className="flex justify-between items-center">
                                        <h2 className="text-[28px] font-semibold text-black">
                                            9:30 <span className="text-[#BFBFBF] text-sm font-bold">AM</span>
                                        </h2>
                                        <p className="text-[13px] text-[#239371] font-bold">Low</p>
                                    </div>
                                    <p className="text-[13px] font-semibold">Investigate login errors.</p>
                                </div>
                                ...
                                <div className="bg-white rounded-[18px] px-3 py-2">
                                    <div className="flex justify-between items-center">
                                        <h2 className="text-[28px] font-semibold text-black">
                                            4:15 <span className="text-[#BFBFBF] text-sm font-bold">PM</span>
                                        </h2>
                                        <p className="text-[13px] text-[#EA6863] font-bold">High</p>
                                    </div>
                                    <p className="text-[13px] font-semibold">Deploy updated app version 3.2.</p>
                                </div>
                            </div>
                        </div>
                    </div>
